...
export ZSH=/Users/wjaaaa/.oh-my-zsh
...
# OPAM configuration
. /Users/wjaaaa/.opam/opam-init/init.zsh > /dev/null 2> /dev/null || true

# Export sml path
export PATH=/usr/local/smlnj/bin:$PATH

# Use mac's internal md5, output in the format of md5sum
# alias md5='md5 -r'
# alias md5sum='md5 -r'

# 11642 working directory
